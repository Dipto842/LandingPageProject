    ...
    <div>
      ...
      <div className="carousel w-full bg-[#F2F4F6]">
        <div id="slide1" className="carousel-item relative w-[1200px]">
          <div className="flex items-center text-center gap-0">
            ...
            <div className="w-[500p]">
              ...
              <h1 className="text-[60px] font-medium w-3 ml-8 text-black">Wall</h1>
              <p className="text-[24px] font_regular w-[22.75rem] ml-8 text-black">
                The perfact Blend of Greenery
              </p>
              <button className="font_medium text-[18px] w-[150px] h-[50px] mt-14 -ml-52 btn rounded-full bg-[#B0DD1D]">
                Shop Now
              </button>
            </div>
          </div>
          <div className="absolute -left-1 -right-4 top-1/2 flex -translate-y-1/2 transform justify-between">
            <a href="#slide2" className="btn btn-circle bg-[#B0DD1D]">
              ❮
            </a>
            <a href="#slide2" className="btn btn-circle mr-5 bg-[#B0DD1D]">
              ❯
            </a>
          </div>
        </div>
        ...
        <div id="slide2" className="carousel-item relative w-[1200px]">
          ...
          <div className="absolute -left-1 -right-4 top-1/2 flex -translate-y-1/2 transform justify-between">
            <a href="#slide1" className="btn btn-circle ml-[19px] bg-[#B0DD1D]">
              ❮
            </a>
            <a href="#slide1" className="btn btn-circle bg-[#B0DD1D]">
              ❯
            </a>
          </div>
        </div>
