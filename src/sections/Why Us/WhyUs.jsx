...
const WhyUs = () => {
  return (
    <div className="w-full max-w-[1200px] mx-auto mt-32 px-4">
      <div className="text-center mb-10">
        <h1 className="text-black text-[42px] font-medium">Why Us</h1>
        <p className="font-regular text-[#0a0a0acd] text-[20px] text-center max-w-[840px] mx-auto">
      ...
      <div className="flex flex-col md:flex-row items-center justify-center gap-10 mt-32">
        {/* 1 */}
        <div className="bg-[radial-gradient(circle_at_top_right,_#a5caee_20%,_#f2f4f6_60%)] w-full md:w-[400px] h-auto md:h-[500px] transition-all duration-300 ease-in-out hover:-translate-y-6 p-6 rounded-xl">
          <div className="w-12 mb-8 ml-9 mt-4">
            <img src={imges1} alt="" />
          </div>
          <h2 className="text-[26px] text-black font-medium mb-2 text-center md:text-left w-full md:w-[320px] mx-auto">
            Unmatched Durability{" "}
            <span className="-ml-6"> with Corrosion-Free</span>{" "}
            <span className="mr-[8rem]">Technology</span>
          </h2>
          <p className="text-gray-700 font-regular text-[17px] w-full md:w-[320px] mx-auto text-left mr-[-5px]">
        ...
        {/* 2 */}
        <div className="bg-[#002b55] w-full md:w-[400px] h-auto md:h-[500px] p-6 rounded-xl transition-all duration-300 ease-in-out hover:-translate-y-6">
          <div className="w-12 mb-8 ml-9 mt-4">
            <img src={imges2} alt="" />
          </div>
          <h2 className="text-[26px] text-left text-white font-medium mb-2 w-full md:w-[320px] mx-auto">
            Customer-Centric Approach
          </h2>
          <p className="text-white font-regular text-[17px] w-full md:w-[320px] mx-auto text-left mr-[-5px]">
        ...
        <div className="bg-[radial-gradient(circle_at_top_right,_#a5caee_20%,_#f2f4f6_60%)] w-full md:w-[400px] h-auto md:h-[500px] transition-all duration-300 ease-in-out hover:-translate-y-6 p-6 rounded-xl">
          ...
          <h2 className="text-[26px] text-black font-medium mb-2 text-left w-full md:w-[320px] mx-auto">
      ...
      <button className="bg-[#B0DD1D] mt-40 w-40 h-12 rounded-full text-black font-medium text-lg mx-auto block">
        Contact us
      </button>
    </div>
  );
